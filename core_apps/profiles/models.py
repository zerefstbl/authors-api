...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("phone number"), max_length=30, default="+11947993906")
    ...
    twitter = models.CharField(verbose_name=_("twitter_handle"), max_length=20, blank=True)
    ...
    def check_if_followed_by(self, profile):
